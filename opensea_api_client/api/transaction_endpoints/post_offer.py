...
from ...models.post_offer_chain import PostOfferChain
from ...models.post_offer_protocol import PostOfferProtocol
from ...types import Response


def _get_kwargs(
    chain: PostOfferChain,
    protocol: PostOfferProtocol,
    *,
    body: Union[
