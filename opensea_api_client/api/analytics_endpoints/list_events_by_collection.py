...
from ...models.list_events_by_collection_event_type_item import ListEventsByCollectionEventTypeItem
...
def _get_kwargs(
    ...
    *,
    ...
    event_type: Union[Unset, List[ListEventsByCollectionEventTypeItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/events/collection/{collection_slug}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get Events (by collection)
     ...
     Get a list of events for a collection. The list will be paginated and include up to 100 events per
    page.
    ...
    Args:
        ...
        event_type (Union[Unset, List[ListEventsByCollectionEventTypeItem]]):
