...
T = TypeVar("T", bound="ConsiderationItem")
...
class ConsiderationItem:
    ...
    Attributes:
        ...
        identifier_or_criteria (int): The ERC721 or ERC1155 token identifier or, in the case of a criteria-based item
            ...
            identifier.
        start_amount (int): The amount of the token in question that will be required should the order be fulfilled.
        end_amount (int): When endAmount differs from `startAmount`, the realized amount is calculated linearly based on
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        consideration_item.additional_properties = d
