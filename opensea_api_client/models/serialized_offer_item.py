...
T = TypeVar("T", bound="SerializedOfferItem")


@_attrs_define
class SerializedOfferItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        serialized_offer_item.additional_properties = d
        return serialized_offer_item
